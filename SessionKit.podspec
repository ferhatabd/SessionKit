...
Pod::Spec.new do |spec|
  ...
  spec.name         = "SessionKit"
  spec.version      = "1.1"
  spec.summary      = "Session infrastructure handling for Dingin Kafa: Meditation app."
  ...
  spec.source       = { :path => "/Users/abdullahoglu/Desktop/Projects/Frameworks/SessionKit/SessionKit", :tag => "#{spec.version}" }
